$(document).ready(function() {
    ...
    function initPlots() {
        ...
        Plotly.newPlot('pattern-metrics', [
            {
                x: [],
                y: [],
                type: 'scatter',
                ...
                data = [
                    {
                        ...
                        type: 'heatmap',
                        colorscale: ionName === 'sodium' ? 'Hot' : 
                                    ionName === 'potassium' ? 'Blues' : 'Greens',
                        zmin: -1,
                        zmax: 1,
                        colorbar: { title: `${ionName.charAt(0).toUpperCase() + ionName.slice(1)} (mM)` }
                    }
                ];
            }
        }// filepath: c:\Users\zaesa\OneDrive\Escritorio\Artificial_counsciousness\bioelectric-consciousness-module\bcm_web\static\js\simulation.js
$(document).ready(function() {
    // State variables
    let currentState = null;
    let iterationCount = 0;
